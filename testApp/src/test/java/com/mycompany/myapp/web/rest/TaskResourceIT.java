...
class TaskResourceIT {
    ...
    private static final Long DEFAULT_MARKS = 1L;
    private static final Long UPDATED_MARKS = 2L;
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).duration(DEFAULT_DURATION).marks(DEFAULT_MARKS);
        return task;
    }
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).duration(UPDATED_DURATION).marks(UPDATED_MARKS);
        return task;
    }
    ...
    void createTask() throws Exception {
        ...
        assertThat(testTask.getMarks()).isEqualTo(DEFAULT_MARKS);
    }
    ...
    void getAllTasks() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.[*].marks").value(hasItem(DEFAULT_MARKS.intValue())));
    }
    ...
    void getTask() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.marks").value(DEFAULT_MARKS.intValue()));
    }
    ...
    void putExistingTask() throws Exception {
        ...
        updatedTask.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).duration(UPDATED_DURATION).marks(UPDATED_MARKS);
        ...
        assertThat(testTask.getMarks()).isEqualTo(UPDATED_MARKS);
    }
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).duration(UPDATED_DURATION).marks(UPDATED_MARKS);
