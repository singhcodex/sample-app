...
export class CompanyService {
  ...
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/companies');
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    ...
    return this.http
      ...
      .pipe(catchError(() => scheduled([new HttpResponse<ICompany[]>()], asapScheduler)));
  }
