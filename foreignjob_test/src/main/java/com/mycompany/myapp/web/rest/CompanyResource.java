...
public class CompanyResource {
    ...
    public ResponseEntity<List<CompanyDTO>> getAllCompanies(
        ...
        if ("industry-is-null".equals(filter)) {
            log.debug("REST request to get all Companys where industry is null");
            return new ResponseEntity<>(companyService.findAllWhereIndustryIsNull(), HttpStatus.OK);
        }
