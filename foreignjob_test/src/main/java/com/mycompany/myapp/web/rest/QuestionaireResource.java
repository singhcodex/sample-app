...
public class QuestionaireResource {
    ...
    /**
     * {@code SEARCH  /_search/questionaires?query=:query} : search for the questionaire corresponding
     * to the query.
     *
     * @param query the query of the questionaire search.
     * @return the result of the search.
     */
    @GetMapping("/_search/questionaires")
    public List<QuestionaireDTO> searchQuestionaires(@RequestParam String query) {
        log.debug("REST request to search Questionaires for query {}", query);
        try {
            return questionaireService.search(query);
