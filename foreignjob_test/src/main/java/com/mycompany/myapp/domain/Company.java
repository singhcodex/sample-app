...
public class Company implements Serializable {
    ...
    public Company employeesCount(Long employeesCount) {
    ...
    public Company addJobs(Job job) {
        this.jobs.add(job);
        job.setCompany(this);
        return this;
    }

    public Company removeJobs(Job job) {
    ...
    public void setIndustry(Industry industry) {
        if (this.industry != null) {
            this.industry.setDepartment(null);
        }
        if (industry != null) {
            industry.setDepartment(this);
        }
        this.industry = industry;
    }
