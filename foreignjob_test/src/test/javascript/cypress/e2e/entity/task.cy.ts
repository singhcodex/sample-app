...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('tan molestias South');
      cy.get(`[data-cy="title"]`).should('have.value', 'tan molestias South');

      cy.get(`[data-cy="description"]`).type('hard oval forenenst');
      cy.get(`[data-cy="description"]`).should('have.value', 'hard oval forenenst');

      cy.get(`[data-cy="duration"]`).type('14872');
      cy.get(`[data-cy="duration"]`).should('have.value', '14872');

      cy.get(`[data-cy="marks"]`).type('11439');
      cy.get(`[data-cy="marks"]`).should('have.value', '11439');
