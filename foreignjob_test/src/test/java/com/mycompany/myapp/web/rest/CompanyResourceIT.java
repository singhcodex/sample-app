...
class CompanyResourceIT {
    ...
    private static final Long DEFAULT_EMPLOYEES_COUNT = 1L;
    private static final Long UPDATED_EMPLOYEES_COUNT = 2L;
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company()
            ...
            .employeesCount(DEFAULT_EMPLOYEES_COUNT);
        return company;
    }
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company()
            ...
            .employeesCount(UPDATED_EMPLOYEES_COUNT);
        return company;
    }
    ...
    public void cleanupElasticSearchRepository() {
        ...
        assertThat(companySearchRepository.count()).isEqualTo(0);
    }
    ...
    void createCompany() throws Exception {
        ...
        assertThat(testCompany.getEmployeesCount()).isEqualTo(DEFAULT_EMPLOYEES_COUNT);
    }
    ...
    void getAllCompanies() throws Exception {
        ...
        restCompanyMockMvc
            ...
            .andExpect(jsonPath("$.[*].employeesCount").value(hasItem(DEFAULT_EMPLOYEES_COUNT.intValue())));
    }
    ...
    void getCompany() throws Exception {
        ...
        restCompanyMockMvc
            ...
            .andExpect(jsonPath("$.employeesCount").value(DEFAULT_EMPLOYEES_COUNT.intValue()));
    }
    ...
    void putExistingCompany() throws Exception {
        ...
        assertThat(testCompany.getEmployeesCount()).isEqualTo(UPDATED_EMPLOYEES_COUNT);
        await()
            .atMost(5, TimeUnit.SECONDS)
            .untilAsserted(() -> {
                int searchDatabaseSizeAfter = IterableUtil.sizeOf(companySearchRepository.findAll());
                assertThat(searchDatabaseSizeAfter).isEqualTo(searchDatabaseSizeBefore);
                List<Company> companySearchList = IterableUtils.toList(companySearchRepository.findAll());
                Company testCompanySearch = companySearchList.get(searchDatabaseSizeAfter - 1);
                assertThat(testCompanySearch.getCompanyName()).isEqualTo(UPDATED_COMPANY_NAME);
                assertThat(testCompanySearch.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
                assertThat(testCompanySearch.getContact()).isEqualTo(UPDATED_CONTACT);
                assertThat(testCompanySearch.getEmail()).isEqualTo(UPDATED_EMAIL);
                assertThat(testCompanySearch.getStreetAddress()).isEqualTo(UPDATED_STREET_ADDRESS);
                assertThat(testCompanySearch.getPostalCode()).isEqualTo(UPDATED_POSTAL_CODE);
                assertThat(testCompanySearch.getCity()).isEqualTo(UPDATED_CITY);
                assertThat(testCompanySearch.getStateProvince()).isEqualTo(UPDATED_STATE_PROVINCE);
                assertThat(testCompanySearch.getCountry()).isEqualTo(UPDATED_COUNTRY);
                assertThat(testCompanySearch.getIndustry()).isEqualTo(UPDATED_INDUSTRY);
                assertThat(testCompanySearch.getEmployeesCount()).isEqualTo(UPDATED_EMPLOYEES_COUNT);
            });
    }
    ...
    void partialUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.email(UPDATED_EMAIL).stateProvince(UPDATED_STATE_PROVINCE).employeesCount(UPDATED_EMPLOYEES_COUNT);
